...
![hist1](./figures/errors_hist_l3.jpg){:height="50%" width="50%"}
![hist2](./figures/errors_hist_t12.jpg){:height="50%" width="50%"}

Example of L3 prediction:
![l3_pred](./figures/l3_pred_example.png){:height="50%" width="50%"}
